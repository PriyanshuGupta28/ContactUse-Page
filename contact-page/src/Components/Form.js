              ...
              <div className="submitButton">
                <button type="submit">
                  ...
                  <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                    <path d="M59.474 38.191L46.996 22.897a2.422 2.422 0 0 0-.848-.66A2.506 2.506 0 0 0 45.086 22h-4.93c-.51 0-.791+ .566-.48.956l10.98 13.456H4.609A.6.6 0 0 0 4 37v4.412a.6.6 0 0 0 .609.588h52.948c2.04 0 3.173-2.265 1.917-3.809Z"></path>
                  </svg>
                </button>
              </div>
            </div>
